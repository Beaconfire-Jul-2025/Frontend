    ...
    <Card className="mb-6">
      ...
      <div className="mb-6">
        <Space direction="vertical" size="small" className="w-full">
          ...
          <Text type="secondary">
            After submitting the I-983 to your school, upload your new I-20
          </Text>
          <UploadFile
            value={value.i20File}
      ...
      {canShowNextOPTStep('I20') && (
        <div className="mb-6">
          <Space direction="vertical" size="small" className="w-full">
            ...
            />
            <Text type="secondary">
              Upload your OPT STEM Receipt (applied for OPT STEM but haven't
              received the EAD yet)
            </Text>
            <UploadFile
      ...
      {canShowNextOPTStep('OPT_STEM_RECEIPT') && (
        <div className="mb-6">
          <Space direction="vertical" size="small" className="w-full">
            ...
            />
            <Text type="secondary">
              Upload your OPT STEM EAD (received the OPT EAD) and wait for HR's
              response
            </Text>
            <UploadFile
